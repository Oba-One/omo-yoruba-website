...
`packages/content/README.md` describing the model as built and every delta from
`docs/design/CONTENT-MODEL.md` with its ADR; the `oy-content-model` and `oy-content-ops` skills
