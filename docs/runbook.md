...
| `SANITY_PREVIEW_SECRET`, `SANITY_WEBHOOK_SECRET` | `packages/web/.env`, Vercel | Generated by the wizard; `/api/revalidate` checks the webhook signature with the second |
