...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "The `labels` option of the Gala's take-part band: every chip one width in a column, no chips, or the chips as small kickers above each heading.",
      },
    },
  },
} satisfies Meta<Args>;
